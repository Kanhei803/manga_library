...
mangaModel.japaneseTitle = "スパイファミリー"
mangaModel.romanjiTitle = "SPYxFAMILY"
mangaModel.publicRating = 8.61
mangaModel.personalRating = 9.00
mangaModel.volumeCount = 11
mangaModel.genre = ['Action', 'Comedy']
mangaModel.theme = ['Childcare']
mangaModel.demographic = ['Shounen']
mangaModel.authorStory = "Endou, Tatsuya"
mangaModel.authorArtist = ""
...
mangaModel.releaseDate = "Mar 25, 2019"
mangaModel.finishedDate = ""
mangaModel.completion = false

// Haikyuu!!
mangaModel.englishTitle = "Haikyu!!"
mangaModel.japaneseTitle = "ハイキュー!!"
mangaModel.romanjiTitle = "Haikyuu!!"
mangaModel.publicRating = 8.85
mangaModel.personalRating = 9.50
mangaModel.volumeCount = 45
mangaModel.genre = ["Award Winning", "Sports"]
mangaModel.theme = ["School", "Team Sports"]
mangaModel.demographic = ["Shounen"]
mangaModel.authorStory = "Furudate, Haruichi"
mangaModel.authorArtist = ""
mangaModel.description = `The whistle blows. The ball is up. A dig. A set. A spike.
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Feb 20, 2012"
mangaModel.finishedDate = "Jul 20, 2020"
mangaModel.completion = true

// Yuru Camp△
mangaModel.englishTitle = "Laid-Back Camp"
mangaModel.japaneseTitle = "Yuru Camp△"
mangaModel.romanjiTitle = "ゆるキャン△"
mangaModel.publicRating = 8.40
mangaModel.personalRating = 9.75
mangaModel.volumeCount = 14
mangaModel.genre = ["Slice of Life"]
mangaModel.theme = ["CGDCT", "Iyashikei"]
mangaModel.demographic = []
mangaModel.authorStory = "Afro"
mangaModel.authorArtist = ""
mangaModel.description = `Setting up a tent, starting a fire, and eating noodles with Mt. Fuji in view...Rin and Nadeshiko absolutely love to camp! Enjoy their zest for travel and maybe even pick up a tip or two about roughing it in the great outdoors. You might just want to go camping yourself!

(Source: Yen Press)`
mangaModel.releaseDate = "May 23, 2015"
mangaModel.finishedDate = ""
mangaModel.completion = false
...
mangaModel.publicRating = 7.91
mangaModel.personalRating = 8.30
mangaModel.volumeCount = 12
mangaModel.genre = ["Comedy"]
mangaModel.theme = ["Romantic Subtext", "School"]
mangaModel.demographic = ["Seinen"]
mangaModel.authorStory = "Yukimori, Nene"
mangaModel.authorArtist = ""
...
(Source: Written by MAL Rewrite`
mangaModel.releaseDate = "Oct 24, 2019"
...
mangaModel.personalRating = 7.75
mangaModel.volumeCount = 26
mangaModel.genre = ["Award Winning", "Comedy", "Drama", "Fantasy", "Gourmet"]
mangaModel.theme = ["Parody"]
mangaModel.demographic = ["Shounen"]
mangaModel.authorStory = "Hashiguchi, Takashi"
mangaModel.authorArtist = ""
mangaModel.description = `Azuma Kazuma isn't terribly clever, but he's got a good heart and great skill—at baking. Since childhood, he's been on a quest to create the perfect bread to represent Japan internationally. Now, he seeks to enter the famous bakery Pantasia, in hopes of reaching his goal. But plots abound...

(Source: ANN)`
mangaModel.releaseDate = "Mar 18, 2002"
...
mangaModel.publicRating = 7.87
mangaModel.personalRating = 8.15
mangaModel.volumeCount = 3
mangaModel.genre = ["Comedy", "Yuri", "Romance"]
mangaModel.theme = []
mangaModel.demographic = []
mangaModel.authorStory = "Miyahara, Miyako"
mangaModel.authorArtist = ""
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Jun 27, 2019"
...
mangaModel.personalRating = 8.38
mangaModel.volumeCount = 11
mangaModel.genre = ["Action", "Comedy"]
mangaModel.theme = []
mangaModel.demographic = ["Shounen"]
mangaModel.authorStory = "Suzuki, Yuuto"
mangaModel.authorArtist = ""
mangaModel.description = `Tarou Sakamoto was considered the greatest hitman of all time. Feared by many, he stood at the top of the underground world until he met and fell in love with a woman. As a result, Sakamoto abandoned his life of crime and now works as a convenience store clerk.
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Nov 21, 2020"
mangaModel.finishedDate = ""
mangaModel.completion = false
...
mangaModel.publicRating = 8.03
mangaModel.personalRating = 8.00
mangaModel.volumeCount = 11
mangaModel.genre = ["Romantic Comedy", "Slice of Life"]
mangaModel.theme = ["Otaku Culture", "Romantic Subtext", "School"]
mangaModel.demographic = ["Seinen"]
mangaModel.authorStory = "Fukuda, Shinichi"
mangaModel.authorArtist = ""
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Jan 19, 2018"
mangaModel.finishedDate = ""
mangaModel.completion = false
...
mangaModel.publicRating = 8.18
mangaModel.personalRating = 8.69
mangaModel.volumeCount = 29
mangaModel.genre = ["Award Winning", "Romantic Comedy", "Coming of Age", "Slice of Life",]
mangaModel.theme = ["Romantic Subtext", "School"]
mangaModel.demographic = ["Shounen"]
mangaModel.authorStory = "Oda, Tomohito"
mangaModel.authorArtist = ""
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "May 18, 2016"
mangaModel.finishedDate = ""
mangaModel.completion = false
...
mangaModel.publicRating = 8.10
mangaModel.personalRating = 8.95
mangaModel.volumeCount = 13
mangaModel.genre = ["Award Winning", "Comedy", "Romantic Comedy"]
mangaModel.theme = []
mangaModel.demographic = ["Shoujo"]
mangaModel.authorStory = "Kawahara, Kazune"
mangaModel.authorArtist = "Aruko"
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Dec 13, 2011"
...
mangaModel.publicRating = 7.36
mangaModel.personalRating = 7.45
mangaModel.volumeCount = 11
mangaModel.genre = ["Romantic Comedy", "Slice of Life"]
mangaModel.theme = ["School"]
mangaModel.demographic = ["Seinen"]
mangaModel.authorStory = "Satomi U"
mangaModel.authorArtist = ""
...
(Source: Written by MAL Rewrite)`
mangaModel.releaseDate = "Mar 4, 2016"
mangaModel.finishedDate = "Mar 19, 2021"
mangaModel.completion = true
